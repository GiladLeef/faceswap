...
from faceswap.utilities import conditional_download, extract_frames, create_temp, get_temp_directory_path, clear_temp, normalize_output_path, is_file, is_directory, is_image, is_video, encode_execution_providers, decode_execution_providers
...
def test_extract_frames_with_trim_start() -> None:
	faceswap.globals.trim_frame_start = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_start_and_trim_end() -> None:
	faceswap.globals.trim_frame_start = 124
	faceswap.globals.trim_frame_end = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_end() -> None:
	faceswap.globals.trim_frame_end = 100
	data_provider =\
	[
		('.assets/examples/target-240p-25fps.mp4', 120),
		('.assets/examples/target-240p-30fps.mp4', 100),
